...
| Work 추적 (`docs/works/` + checklist.json) | native TaskCreate/TaskList | `kit-only` | 네이티브 Task는 세션 스코프(`~/.claude/tasks/<session>/`) — 세션 경계를 못 넘어 durable checklist가 갭을 메움 (W-013). 네이티브가 cross-session task를 제공하면 흡수 후보 |
...
| Agent Evals (`evals/`) | (대응 네이티브 없음) | `kit-only` | 2026-07-07 기준 네이티브 에이전트 행동 평가 프리미티브 부재 (W-014 T-B). 네이티브 evals 출시 시 최우선 흡수 후보 |
...
| 날짜 | 검토자 | 변경 |
| --- | --- | --- |
| 2026-07-07 | W-014 T-C (초기 역기입) | 기존 결정(W-005·W-006·W-007·W-013·W-014) 역기입, 초기 13행 작성 |
